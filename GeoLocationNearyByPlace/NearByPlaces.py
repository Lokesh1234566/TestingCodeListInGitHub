...
def find_nearby_places(lat, lon, place_type, radius):
    ...
    # location = geolocator.reverse(26.9212, 75.7918)
...
if __name__ == "__main__":
    ...
    if user_lat is not None and user_lon is not None:
        place_type = input(
            "What type of place are you looking for? (e.g., park, mall, ATM, hotel): "
        )
        ...
        find_nearby_places(float(26.9212), float(75.7918), place_type, search_radius)
        # find_nearby_places(float(12.9719), float(77.5937), place_type, search_radius)
